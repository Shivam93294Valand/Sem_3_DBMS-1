...
SELECT NAME, CITY INTO EMPLOYEE_DATA FROM EMPLOYEE WHERE 3=0;
...
UPDATE DEPOSIT SET AMOUNT = 500 WHERE ACTNO BETWEEN 103 AND 107;
...
--5. Update the Loan Amount to 5000, Branch to VRCE & Customer Name 
--   to Darshan whose loan no is 481. (Use Borrow Table)
UPDATE BORROW SET AMOUNT = 5000, BNAME = 'VRCE', CNAME = 'DARSHAN' WHERE LOANNO = 481;

--6. Update the Deposit table and set the date to 01-01-2021 for all the depositor
--	 whose amount is less than 2000.
UPDATE DEPOSIT SET ADATE = '2021-1-1'WHERE AMOUNT < 2000;

--7. Update the Deposit table and set the date to NULL & Branch name to ‘ANDHERI 
--	 whose Account No is 110.
